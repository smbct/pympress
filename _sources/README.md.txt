...
[debian_version]: https://img.shields.io/debian/v/pympress/stable?logo=debian
...
- **Preferences**: Some of your choices are saved in a configuration file, and more options are accessible there. See the [configuration file documentation](options.md) for more details.
